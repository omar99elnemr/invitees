                    ...
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div className="max-h-96 overflow-y-auto mb-6">
                            {isLoading ? (
                                ...
                                <>
                                    <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Active Categories</h4>
                                    <ul className="divide-y divide-gray-200">
                                        ...
                                        {categories.filter(c => c.is_active).length === 0 && (
                                            <li className="py-2 text-sm text-gray-500 italic">No active categories</li>
                                        )}
                                    </ul>

                                    <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2 mt-6">Inactive Categories</h4>
                                    <ul className="divide-y divide-gray-200 bg-gray-50 rounded-md">
                                        ...
                                        {categories.filter(c => !c.is_active).length === 0 && (
                                            <li className="p-2 text-sm text-gray-500 italic text-center">No inactive categories</li>
                                        )}
                                    </ul>
                                </>
                            )}
                        ...
                        {/* Add New */}
                        <form onSubmit={handleAdd} className="mt-4 border-t border-gray-200 pt-4">
                        ...
                        {deletingId && usageStats && (
                            <div className="absolute inset-x-0 bottom-0 px-4 pb-4 sm:inset-0 sm:flex sm:items-center sm:justify-center">
                                ...
                                <div className="bg-white rounded-lg px-4 pt-5 pb-4 overflow-hidden shadow-xl transform transition-all sm:max-w-sm sm:w-full z-10 relative">
                                    <div>
                                        ...
                                        <div className="mt-3 text-center sm:mt-5">
                                            ...
                                            <div className="mt-2">
                                                ...
                                                {(usageStats.contacts > 0 || usageStats.event_invitations > 0) ? (
                                                    <div className="mt-2 p-2 bg-red-50 rounded text-left text-xs text-red-700">
    ...
    return (
        <li className="py-3 flex items-center justify-between group">
            {isEditing ? (
                ...
                <span className={clsx("text-sm font-medium", !category.is_active && "text-gray-500 line-through")}>
                    {category.name}
                </span>
            )}
            ...
            <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                {!isEditing && (
                    <>
                        <button
                            onClick={onToggle}
                            className={clsx("p-1 rounded hover:bg-gray-100", category.is_active ? "text-orange-500" : "text-green-500")}
