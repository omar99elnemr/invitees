    ...
    <div ref={containerRef} className="relative">
      <div className="relative">
        <input
          ...
          className={`w-full px-3 py-2 pr-16 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent ${
                ...
                filteredCategories.map((category) => (
                  <button
                    ...
                    className={`w-full px-3 py-2 text-left hover:bg-gray-100 ${
                      value === category ? 'bg-primary/5 text-primary' : 'text-gray-900'
                    }`}
                  >
                    {category}
                  </button>
