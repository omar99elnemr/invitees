                  ...
                  <td className="px-2 sm:px-4 py-2 sm:py-3">
                    <div className="flex items-center">
                      ...
                      <div className="sm:ml-4 min-w-0">
                        <div className="text-xs sm:text-sm font-medium text-gray-900 dark:text-white whitespace-normal break-words">{user.full_name || user.username}</div>
                      ...
                      <tr key={group.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                        <td className="px-2 sm:px-4 py-2 sm:py-3">
                          <div className="flex items-center">
                            ...
                            <div className="sm:ml-4 min-w-0">
                              <div className="text-xs sm:text-sm font-medium text-gray-900 dark:text-white whitespace-normal break-words">{group.name}</div>
                            </div>
                          </div>
                        </td>
                        <td className="hidden md:table-cell px-2 sm:px-4 py-2 sm:py-3">
                          <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 whitespace-normal break-words">
                            {group.description || '-'}
                          </div>
                        </td>
                        <td className="px-2 sm:px-4 py-2 sm:py-3">
                      ...
                      return (
                        <tr key={inviter.id} className={`hover:bg-gray-50 dark:hover:bg-gray-700 ${selectedInviterIds.includes(inviter.id) ? 'bg-red-50 dark:bg-red-900/20' : ''}`}>
                          ...
                          <td className="px-2 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm font-medium text-gray-900 dark:text-white">
                            <span className="whitespace-normal break-words block">{inviter.name}</span>
                          </td>
