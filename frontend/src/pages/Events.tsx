...
import { eventsAPI, inviterGroupsAPI } from '../services/api';
    ...
    <div className="space-y-6">
              ...
              <div className="p-6">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium mt-2 ${statusColors[event.status]}`}>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
            <div className="p-6">
              ...
              <h3 className="text-lg font-semibold text-center mb-2">Delete Event</h3>
      ...
      {showStatusModal && selectedEvent && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
            <div className="p-6">
              <h3 className="text-lg font-semibold mb-4">Change Event Status</h3>
